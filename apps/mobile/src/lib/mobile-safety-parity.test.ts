...
describe("mobile person profile groups into Them | Yours with Today above the strip", () => {
  it("wiring: profile uses shared group labels, Today is not a tab, defaults to Them", () => {
