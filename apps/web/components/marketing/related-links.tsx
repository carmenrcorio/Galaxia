 ...
 * (/why-galaxia, /generations, /meet-vela, /security, /pricing,
 * /methodology), the Quick Chart tools (/chart, /chart/compare), and out
 * to the blog — the internal-linking pass that keeps every standalone
 * page reachable in 2 clicks from `/` without dropping a full site-map
 * onto each one. Every caller picks the 2-3 pages that are actually the
 * next relevant read from where the visitor already is; this component
 * only renders that short, deliberate list.
 */
