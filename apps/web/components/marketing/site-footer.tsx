 ...
 * (/why-galaxia, /generations, /meet-vela, /for-work, /press, /security,
 * /pricing, /glossary), and the blog. All real routes now — no in-page
 * anchors — so every link resolves the same way no matter which page the
 * footer is rendered on. Quick Chart and Download are named here because
 * both are public, logged-out surfaces.
 */
