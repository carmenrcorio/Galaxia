/**
 * VERIFY proof (Stage 2, support queue) against a LIVE, disposable Supabase
 * project (no local stack in this repo — see AGENTS.md), same pattern as
 * `read-admin-row.live.test.ts`.
 *
...
describe("VERIFY (live): support_requests RLS — insert-your-own, no read/update/delete for anyone", () => {
