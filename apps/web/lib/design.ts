 ...
 * initial value (black), not the intended element colour. `exportVar` is
 ...
 * resolves correctly already (family-compare / memorial-timeline proved
 * this before this file existed).
 */
