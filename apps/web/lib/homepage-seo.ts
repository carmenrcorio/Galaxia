...
/** FOUNDER-REVIEW: locked homepage tagline. Exact text, punctuation, capitalization. */
export const HOMEPAGE_TAGLINE = "Your Life. Your People. Your Galaxy.";

/** FOUNDER-REVIEW: homepage <title>, og:title, and twitter:title. */
export const HOMEPAGE_TITLE = "Your Life. Your People. Your Galaxy. | Galaxia";

/**
 * FOUNDER-REVIEW: homepage meta description, og:description, and
 * twitter:description. The three locked clauses stay intact; astrology
 * vocabulary stays because metadata is layer two (ENGINEERING.md §17).
 */
