...
export const RELATED_LINKS = {
  whyGalaxia: [
    ...
    { href: "/chart/compare", label: "Compare your chart with someone's" },
  ...
  chartCompare: [
    ...
    { href: "/generations", label: "See the generational layer behind two charts" },
  ],
  forWork: [
    { href: "/chart", label: "Try a free chart" },
...
export const CHART_MODE_COMPARE: NavLink = { href: "/chart/compare", label: "Compare two charts" };
