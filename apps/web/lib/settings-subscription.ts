...
export const SETTINGS_SUBSCRIPTION_COPY = {
  ...
  timeout:
    `We could not load your subscription details in time. What we know: this page did not receive your account record. Email ${GALAXIA_HELP_EMAIL} and we will look it up.`,
    error:
    `We could not load your subscription details. What we know: the request failed. Email ${GALAXIA_HELP_EMAIL} and we will look it up.`,
    unknown:
    `We do not have a subscription record for this account yet. Email ${GALAXIA_HELP_EMAIL} if this looks wrong.`,
