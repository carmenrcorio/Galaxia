...
`[CHANGED]` **Copy share link discloses what the recipient will see**, including birth date and place on a gifted natal chart. PDF footnote now carries `galaxiamea.com`. On a public gift page, a failed or hung session lookup falls through to the signed-out add CTA instead of leaving "Checking whether you are signed in."
