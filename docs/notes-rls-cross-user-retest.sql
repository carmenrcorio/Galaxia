-- Cross-user isolation re-test for public.notes (the Record).
...
BEGIN
  ...
  VALUES (
    ...
    'authenticated',
    'authenticated',
    'notes-rls-probe-b@galaxia.invalid',
  ...
  RAISE EXCEPTION 'ISOLATION_OK notes_visible_to_B=0: rolling back probe user';
END $$;
