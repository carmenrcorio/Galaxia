 ...
 * Does not apply exclude_from_dailies. That flag is Today and the
 * morning note only. A passed person is never "what's pulling on
 * two people in your circle at once."
 */
